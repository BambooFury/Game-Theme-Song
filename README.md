...
| <img src="https://api.iconify.design/lucide:file-music.svg?color=%2367c1f5" width="16"> **Custom Music** - set your own audio track per game; your pick always overrides the auto-theme | <img src="https://api.iconify.design/lucide:list-music.svg?color=%232ecc71" width="16"> **Music Library** - searchable window listing your games to assign and manage custom tracks |
| <img src="https://api.iconify.design/lucide:sliders-horizontal.svg?color=%232ecc71" width="16"> **Volume Slider** - 0-100% with 1% precision, applied live while music plays | <img src="https://api.iconify.design/lucide:hand-metal.svg?color=%23ff4d4f" width="16"> **Welcome Tour** - friendly one-time intro window after install |
...
2. <img src="https://api.iconify.design/lucide:radar.svg?color=%23FFD43B" width="16"> The backend searches the game's official soundtrack and picks the main theme track
...
<img src="https://api.iconify.design/lucide:trash-2.svg?color=%23ff4d4f" width="16"> **Clear Downloaded Music** - shows cached track count and size; clears the local cache to free disk space
...
1. <img src="https://api.iconify.design/lucide:library.svg?color=%231a9fff" width="16"> Open `Steam Menu → Millennium → Game Theme Song` and click **Music Library**
...
Yes - open **Music Library** in the plugin settings, search for a game and choose any audio file (MP3, M4A, AAC, OGG, OPUS, WAV, FLAC, up to 50 MB). Your track is saved locally and always takes priority over the auto-theme.
...
The plugin picks the closest matching soundtrack it can find, so you still get fitting theme music for almost every game - or set your own custom track for a perfect match.
