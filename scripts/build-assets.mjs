...
const timerIcon    = readFileSync(join(settingsDir, 'timer.svg'), 'utf8').trim();
const gamepadIcon  = readFileSync(join(settingsDir, 'gamepad.svg'), 'utf8').trim();
...
const searchIcon   = readFileSync(join(settingsDir, 'search.svg'), 'utf8').trim();
...
export const SETTINGS_ICONS = {
  repeat: ${asTsLiteral(repeatIcon)},
  volume: ${asTsLiteral(volumeIcon)},
  timer: ${asTsLiteral(timerIcon)},
  gamepad: ${asTsLiteral(gamepadIcon)},
  trash: ${asTsLiteral(trashIcon)},
  library: ${asTsLiteral(libraryIcon)},
  search: ${asTsLiteral(searchIcon)},
};
`;
